...
print("\033[0;36m >> install tools Doss: 9")
...
print("\033[1;32minstall hulk >> :   1")	

	

print("\033[1;35m~~~~~~~")

print("\033[0;33minstall DDOS >> :   2")	

print("\033[1;35m~~~~~~~")

print("\033[0;32mminstall pentmenu >> :   3")

print("\033[1;35m~~~~~~~")

o = input("\033[4;34mEnter number tool : ")
...
if o == "1":
	...
	os.system("chmod +x hulk.py")

	os.system("python2 hulk.py")

print("\033[1;35m~~~~~~~")

if o == "2":

	os.system("git clone https://github.com/Dr-Data2/KlarDDos ")

	os.system("cd KlarDDos ")

	os.system("pip install -r installing.txt ")

	os.system("python3 KlarDdos.py -h ")
...
if o == "3":
	...
	os.system("git clone https://github.com/GinjaChris/pentmenu")

	os.system("cd pentmenu")

	os.system("chmod 777 *")

	od.system("bash pentmenu")
